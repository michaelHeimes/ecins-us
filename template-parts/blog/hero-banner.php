 ...
 * @package      sixheads
 **/
$title = get_field('hero_title_blog', 'option');
...
<header class="hero-banner">
  <div class="wrapper hero-banner__container">
	  <div class="inner">
	  		<div class="half left">
			    <?php if (get_field('hero_copy_blog', 'option')) : ?>
			      <div class="page-title hero-banner__title"><?php the_field('hero_copy_blog', 'option'); ?></div>
			    <?php else : ?>
