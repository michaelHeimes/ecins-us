...
$title = get_field('hero_title_events', 'option');
$image = get_field('hero_image_events', 'option');
?>
	  ...
	  <div class="inner">
	  		<div class="half left">
			    <?php if (get_field('hero_copy_news', 'option')) : ?>
			      <div class="page-title hero-banner__title"><?php the_field('hero_copy_events', 'option'); ?></div>
			    <?php else : ?>
