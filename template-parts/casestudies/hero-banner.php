...
$title = get_field('hero_title_casestudies', 'option');
$image = get_field('hero_image_casestudies', 'option');
?>
	  ...
	  <div class="inner">
	  		<div class="half left">
			    <?php if (get_field('hero_copy_news', 'option')) : ?>
			      <div class="page-title hero-banner__title"><?php the_field('hero_copy_casestudies', 'option'); ?></div>
			    <?php else : ?>
